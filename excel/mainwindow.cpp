...
void MainWindow::saveTable()
{
    ...
    QAxObject *workbook = workbooks->querySubObject( "Open(const QString&)", QUrl::fromLocalFile(file) );
    ...
    QMessageBox::information(NULL,QObject::tr("Information"), tr("Table saved"));
}
